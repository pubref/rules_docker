...
docker_build_ = rule(
    ...
    attrs = {
        ...
        "build_layer": attr.label(
            default=Label("@bazel_tools//tools/build_defs/pkg:build_tar", relative_to_caller_repository = True),
            cfg="host",
            executable=True,
            allow_files=True),
        "create_image": attr.label(
            default=Label("@bazel_tools//tools/build_defs/docker:create_image", relative_to_caller_repository = True),
            cfg="host",
            executable=True,
            allow_files=True),
        "incremental_load_template": attr.label(
            default=Label("//docker:incremental_load.sh.tpl", relative_to_caller_repository = False),
            single_file=True,
            allow_files=True),
        "join_layers": attr.label(
            default=Label("@bazel_tools//tools/build_defs/docker:join_layers", relative_to_caller_repository = True),
            cfg="host",
            executable=True,
            allow_files=True),
        "rewrite_tool": attr.label(
            default=Label("@bazel_tools//tools/build_defs/docker:rewrite_json", relative_to_caller_repository = True),
            cfg="host",
            executable=True,
            allow_files=True),
        "create_image_config": attr.label(
            default=Label("@bazel_tools//tools/build_defs/docker:create_image_config", relative_to_caller_repository = True),
            cfg="host",
            executable=True,
            allow_files=True),
        "sha256": attr.label(
